...
// cosmoscoin: total coins staked (non-spendable until maturity)
...
// CosmosCoin: get current stake weight
...
// cosmoscoin: check 'spent' consistency between wallet and txindex
// cosmoscoin: fix wallet spent state according to txindex
...
// cosmoscoin: disable transaction (only for coinstake)
